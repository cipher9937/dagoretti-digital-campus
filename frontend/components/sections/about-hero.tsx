  ...
  return (
    <section className="relative pt-32 pb-20 bg-navy-950">
      ...
      <div className="container-padding mx-auto max-w-7xl relative z-10">
        ...
        >
          <span className="text-gold-400 font-semibold text-sm uppercase tracking-wider">About Our School</span>
          <h1 className="text-4xl lg:text-5xl font-bold text-white mt-4 mb-6">
            Dagoretti High School
          </h1>
          <p className="text-navy-200 text-lg leading-relaxed">
            A National School in Nairobi, Kenya with a rich heritage of academic excellence, 
            leadership, and discipline since 1929.
          </p>
        </motion.div>
      </div>
    </section>
